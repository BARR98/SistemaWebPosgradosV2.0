...
@NgModule({
  declarations: [ AdminLayoutComponent,MastersListComponent, AdminHomeComponentComponent,CreateComponentComponent, EditMasterComponent, UserComponent, ImageFormComponent, ImagesListComponent, ImagePreviewComponent, ViewMasterImagesComponent, FilesListComponent, ViewMasterFileComponent, FileFormComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    AdminSharedModule,
